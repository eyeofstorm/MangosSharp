                        ...
                        try
                        {
                            ...
                            do
                            {
                                if (spellDBC.ReadInt(i, 61 + k) != 0)
                                {
                                    ...
                                    var spellEffect = new WS_Spells.SpellEffect(ref Spell);
                                    sPELLs[key] = Spell;
                                    var spellEffect2 = spellEffect;
        ...
        public async Task LoadTalentDbcAsync()
        {
            checked
            {
                try
                {
                    ...
                    for (var i = 0; i <= num; i++)
                    {
                        var tmpInfo = new WS_DBCDatabase.TalentInfo
                        {
        ...
        public async Task LoadItemDisplayInfoDbcAsync()
        {
            checked
            {
                try
                {
                    ...
                    for (var i = 0; i <= num; i++)
                    {
                        var tmpItemDisplayInfo = new WS_DBCDatabase.TItemDisplayInfo
                        {
                            ID = dbc.ReadInt(i, 0),
        ...
        public async Task LoadItemRandomPropertiesDbcAsync()
        {
            checked
            {
                try
                {
                    ...
                    for (var i = 0; i <= num; i++)
                    {
                        var tmpInfo = new WS_DBCDatabase.TItemRandomPropertiesInfo
                        {
                            ID = dbc.ReadInt(i, 0)
                        };
        ...
        public async Task LoadCreatureFamilyDbcAsync()
        {
            checked
            {
                try
                {
                    ...
                    for (var i = 0; i <= num; i++)
                    {
                        var tmpInfo = new WS_DBCDatabase.CreatureFamilyInfo
                        {
                            ID = dbc.ReadInt(i, 0),
        ...
        public void LoadQuestStartersAndFinishers()
        {
            ...
            checked
            {
                ...
                try
                {
                    ...
                    {
                        var row = (DataRow)enumerator3.Current;
                ...
                try
                {
                    ...
                    {
                        var row = (DataRow)enumerator4.Current;
                        var entry = row.As<int>("entry");
