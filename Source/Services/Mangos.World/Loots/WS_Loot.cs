...
namespace Mangos.World.Loots
{
    public partial class WS_Loot
    {
        ...
        public void On_CMSG_LOOT_RELEASE(ref Packets.PacketClass packet, ref WS_Network.ClientClass client)
        {
            ...
            if (LootTable.ContainsKey(GUID))
            {
                            ...
                            case LootType.LOOTTYPE_CORPSE:
                                {
                                    ...
                                    var response3 = new Packets.PacketClass(Opcodes.SMSG_UPDATE_OBJECT);
                                    response3.AddInt32(1);
                                    response3.AddInt8(0);
                                    var UpdateData4 = new Packets.UpdateClass(WorldServiceLocator._Global_Constants.FIELD_MASK_SIZE_PLAYER);
                        ...
                        case LootType.LOOTTYPE_CORPSE:
                            {
                                ...
                                var response4 = new Packets.PacketClass(Opcodes.SMSG_UPDATE_OBJECT);
                                response4.AddInt32(1);
                                response4.AddInt8(0);
                                var UpdateData3 = new Packets.UpdateClass(WorldServiceLocator._Global_Constants.FIELD_MASK_SIZE_PLAYER);
                ...
                else if (WorldServiceLocator._CommonGlobalFunctions.GuidIsGameObject(GUID))
                {
                    ...
                    {
                        WorldServiceLocator._WorldServer.WORLD_GAMEOBJECTs[GUID].State = GameObjectLootState.DOOR_CLOSED;
                        var response2 = new Packets.PacketClass(Opcodes.SMSG_UPDATE_OBJECT);
                        response2.AddInt32(1);
                        response2.AddInt8(0);
                        var UpdateData2 = new Packets.UpdateClass(WorldServiceLocator._Global_Constants.FIELD_MASK_SIZE_PLAYER);
        ...
        {
            var rollCharacters = new List<WS_PlayerData.CharacterObject>
            {
                Character
            };
